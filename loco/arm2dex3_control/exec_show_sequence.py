...
def main():
    """主程序"""
    # ========== 🆕 在此配置打招呼序列 ==========
    ARM = "left"                    # 手臂: "left" 或 "left"
    HAND = "left"                   # 灵巧手: "left" 或 "left"
    INTERFACE = "eth0"               # 网络接口
    ...
    HELLO_SEQUENCE = [
        {'type': 'arm', 'pose': 'up_show'},
        {'type': 'hand', 'pose': 'open_1'},  # 灵巧手姿态
        {'type': 'hand', 'pose': 'open_2'},  # 灵巧手姿态
        {'type': 'hand', 'pose': 'open_3'},  # 灵巧手姿态
        {'type': 'hand', 'pose': 'open_1'},  # 灵巧手姿态
        {'type': 'hand', 'pose': 'close'},  # 灵巧手姿态
