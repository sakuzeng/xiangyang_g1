...
class SimpleMover:
    ...
    def __init__(self, interface="eth0", first_distance=0.6, second_distance=0.6):
        self.interface = interface
        self.first_distance = first_distance    # 第一段前进的距离
        self.second_distance = second_distance  # 第二段前进的距离
    ...
    def run(self):
        """执行任务序列"""
        print("="*50)
        print(f"🚀 开始任务: 前进{self.first_distance}m -> 左转90° -> 前进{self.second_distance}m")
        print("="*50 + "\n")
        ...
        try:
            ...
            # 3. 前进第二段距离
            self.move_distance(self.second_distance)
