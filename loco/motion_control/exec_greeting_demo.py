...
# 配置日志
logger = setup_logger("greeting_demo")

def main():
    # === 配置 ===
    VOICE_TEXT = "尊敬的各位领导大家好，我是监控机器人小安，欢迎莅临江南集控站指导工作。"
    INTERFACE = sys.argv[1] if len(sys.argv) > 1 else "eth0"
    TTS_SOURCE = "greeting"
    
    # === 初始化 ===
    logger.info("🚀 启动迎宾演示程序...")
    ...
    try:
        ...
        # 释放 TTS 独占
        logger.info(f"🔓 释放 TTS 独占 ({TTS_SOURCE})...")
